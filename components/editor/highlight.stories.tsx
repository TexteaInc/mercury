...
export const Primary: Story = {
  args: {
    ...
    highlights: [
      { start: 0, end: 10, color: "hsl(210, 70%, 50%)", score: 0.9 },
      { start: 15, end: 25, color: "hsl(120, 40%, 60%)", score: 0.8 },
      { start: 20, end: 30, color: "hsl(240, 40%, 60%)", score: 0.7 },
      { start: 35, end: 50, color: "hsl(300, 40%, 60%)", score: 0.6 },
      { start: 40, end: 55, color: "hsl(30, 40%, 60%)", score: 0.5 },
      { start: 45, end: 60, color: "hsl(210, 70%, 50%)", score: 0.4 },
    ],
  },
}
